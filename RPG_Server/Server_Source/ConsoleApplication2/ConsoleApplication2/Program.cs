...
namespace ConsoleApplication2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string s0 = "中国软件 tttt csdn.netdfgdfgdfgdfgdfgdfg99999";
            string s1 = EncryptString(s0, key);
            string s2 = DecryptString(s1, key);
            Console.WriteLine("原串: [{0}]", s0);
            Console.WriteLine("加密: [{0}]", s1);
            Console.WriteLine("解密: [{0}]", s2);
            Console.ReadKey();
        }
        //public static byte[] Keys = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF, 0xCD, 0xEF, 0x78 };
